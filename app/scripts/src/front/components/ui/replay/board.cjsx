React = require 'react'
CardOnBoard = require './card/card-on-board'
_ = require 'lodash'
...
class Board extends React.Component
	...
	render: ->
		...
		cards = @props.entity.getBoard().map (entity) ->
			...
			cardDiv = <CardOnBoard entity={entity} key={entity.id} stats={true} ref={entity.id} tooltip={tooltip} cardUtils={replay.cardUtils} replay={replay} conf={conf}/>
