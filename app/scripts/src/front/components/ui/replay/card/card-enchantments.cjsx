...
class CardEnchantments extends React.Component
	...
	render: ->
		...
		enchantments = entity.getEnchantments().map (enchant) ->
			...
			enchantImageUrl = "http://static.zerotoheroes.com/hearthstone/cardart/256x/#{enchantor.cardID}.jpg"
			...
			<div className="enchantment" key={'enchantment' + entity.id + enchant.cardID + seqNumber++}>
				...
				<div className="info-container">
					...
					<img className="ring" src="http://static.zerotoheroes.com/hearthstone/asset/manastorm/enchantment-ring.png" />
