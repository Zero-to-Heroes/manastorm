...
ActiveSpell = React.createClass
	...
	render: ->
		...
		return 	<RenderedCard entity={@spell} key={@spell.id} ref={@spell.id} cardUtils={@props.replay.cardUtils} replay={@props.replay} conf={@props.conf} className="active-spell"/>
